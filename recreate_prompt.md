                ...
                <div class="template-project-card project-panel">
                    ...
                    <div class="content-panel">
                        ...
                        <ul>
                            ...
                            <li>Improved product retrieval speed and system stability, reducing search time by up to 50% through AVL treeâ€“based indexing</li>
                        </ul>
                        <div class="techstack-container">
                        ...
                        <div class="project-links">
                            <a href="#" class="btn-pill solid-white">
        ...
        <section id="contact-me" class="contact-section reveal delay-2" style="margin-top: 3rem;">
            <div class="contact-layout">
                ...
                <div class="contact-form-card">
                    <form action="mailto:narendra18reddy@gmail.com" method="POST" enctype="text/plain" class="contact-form">
                        <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <textarea placeholder="Feel free to reach out..." rows="5" required></textarea>
                        </div>
                        <button type="submit" class="submit-btn"><i class="fas fa-paper-plane" style="margin-right: 8px;"></i> SEND INQUIRY</button>
                    </form>
                </div>
            </div>
        </section>
